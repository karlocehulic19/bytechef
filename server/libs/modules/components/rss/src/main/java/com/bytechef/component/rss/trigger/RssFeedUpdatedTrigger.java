 ...
 */
public class RssFeedUpdatedTrigger {
    public static final ModifiableTriggerDefinition TRIGGER_DEFINITION = trigger("feedUpdated")
        .title("Feed Updated")
                        ...
                        object("data")
                            ...
                            .properties(
                                ...
                                array("items_changed")
                                    ...
                                    .items(ITEM_OBJECT)))))
        .webhookRequest(RssFeedUpdatedTrigger::webhookRequest);

    private RssFeedUpdatedTrigger() {
    }
